...
export const addTodoAction: TActionFunction = createAction<
  ITodo,
  {}
>(actionTypes.ADD_TODO, (todo: ITodo): ITodo => todo);

export const updateTodoAction: TActionFunction = createAction<
  ITodo,
  ITodoId
>(
